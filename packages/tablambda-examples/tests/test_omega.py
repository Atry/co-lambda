...
from tablambda._ast import BOTTOM
from tablambda._shape import weak_head_normalize
from tablambda_examples._omega import OMEGA, self_contraction, solve_omega

from tablambda_examples import _omega_code, _omega_figure, _omega_trace
