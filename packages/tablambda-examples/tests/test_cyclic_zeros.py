...
from tablambda._ast import make_app
from tablambda._shape import weak_head_normalize
from tablambda_examples._cyclic_zeros import (
    STREAM,
    W_APPLIED,
    W_SELF,
    cons_cell,
...
from tablambda_examples import _cyclic_zeros_figure, _cyclic_zeros_trace
