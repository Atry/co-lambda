...
``tablambda-editdistance-trace`` (``python -m tablambda_examples._editdistance_trace``) rewrites it.
"""
...
import tablambda._shape as shape_module

from tablambda._ast import App, Node
from tablambda._dsl import _AppBuilder, app, build, lam
...
def render_trace(events: "tuple[TraceEvent, ...]") -> str:
    ...
    header = (
        "% Generated by tablambda_examples._editdistance_trace (tablambda-editdistance-trace). Do not edit;\n"
        "% regenerate with: python -m tablambda_examples._editdistance_trace\n"
    )
