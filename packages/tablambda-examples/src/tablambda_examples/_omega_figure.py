...
``tablambda-omega-figure`` (``python -m tablambda_examples._omega_figure``) rewrites the committed
...
from tablambda_examples._omega import solve_omega
...
def render_tikz() -> str:
    ...
    lines = [
        "% Generated by tablambda_examples._omega_figure (tablambda-omega-figure). Do not edit;",
        "% regenerate with: python -m tablambda_examples._omega_figure",
