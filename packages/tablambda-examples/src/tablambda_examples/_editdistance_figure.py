...
``tablambda-editdistance-figure`` (``python -m tablambda_examples._editdistance_figure``) rewrites the
...
from tablambda._ast import App
...
def render_tikz(trace: EditDistanceTrace) -> str:
    ...
    lines = [
        "% Generated by tablambda_examples._editdistance_figure (tablambda-editdistance-figure). Do not edit.",
