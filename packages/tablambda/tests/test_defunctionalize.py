...
from tablambda._ast import Node, make_app, make_lam, make_var
from tablambda._defun_runtime import Thunk, _BOTTOM, _is_thunk, _python_tag, interned
...
def test_codec_classdef_roundtrip():
    ...
    import ast
    from tablambda._pyast import encode, decode
