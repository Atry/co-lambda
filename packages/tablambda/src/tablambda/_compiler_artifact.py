...
without triggering any in-process compilation. Running this script (or ``tablambda-regen-compiler``)
...
def module_dotted_name() -> str:
    ...
    return f"tablambda._generated.{module_basename()}"
...
def generate() -> Path:
    ...
    from tablambda._defunctionalize import defun_compiler_source
